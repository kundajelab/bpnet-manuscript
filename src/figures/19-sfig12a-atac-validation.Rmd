---
title: 'sfig12a: D.E. ATAC-seq classifications to validate motifs'
...
options(knitr.figure_dir="figures/19-sfig12a-atac-validation")
...
bpnet_motif_pairs.csv.filepath<-"data/csv/motif_pairs.csv" #generated in `21_*.ipynb`
...
ggsave("figures/19-sfig12a-atac-validation/sfig12a-qc_overlap_perc_ov_bpnet_motifs_10k.pdf", qc_overlap_perc_bpnet.plot, height = 4, width = 10)
ggsave("figures/19-sfig12a-atac-validation/sfig12a-qc_overlap_perc_ov_bpnet_motifs_10k.png", qc_overlap_perc_bpnet.plot, height = 4, width = 10)
```
