---
title: "fig3g, sfig4b: Spacing of Motifs across Transposable Elements"
...
options(knitr.figure_dir="16-fig3g_sfig4b-strict-motif-spacing", width=16, height=20)
...
colnames(repeats.df)<-c("SW_score","perc_div","perc_del","perc_ins","chr","start","end","left","strand","matching_repeat","repeat_class","position_start","position_end","repeat","id")
