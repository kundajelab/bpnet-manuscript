---
title: "sfig13a: Investigation of Nanog-Sox Heterodimer"
...
options(knitr.figure_dir="figures/20-sfig13a-nanog-sox-alternative-partner")
...
```{r sfig13a-nanog-sox-motif-logo}
#Plot pos motif
...
#Save to PDF
pdf("figures/20-sfig13a-nanog-sox-alternative-partner/sfig13a-nanog-sox-motif-logo.pdf", width = 7.8, height=3)
plot(CATT_PWM_matches_motif)
dev.off()
```
...
```{r sfig13a-nanog-sox-motif-heatmaps}
...
grid.newpage()
pdf("figures/20-sfig13a-nanog-sox-alternative-partner/sfig13a-nanog-sox-heatmaps.pdf", width = 7, height = 12) # Open a new pdf file
