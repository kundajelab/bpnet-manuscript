...
- [x] ScalarHead (BinaryCls, Regression)
- [x] Profile
- [?] NormalizedProfile
  - // Have a flag whether to average the importance scores or not (for now, always average the strands.)
"""
import numpy as np
from basepair.utils import dict_prefix_key
