...
#     def plot_seqlet_upset(self):
#         """Compute the seqlet stats

#         # N seqlets per sequence
#            - TODO - plot the quasi overlap
#         """
#         from upsetplot import plot as upsetplt
#         data_dict = self.seqlet_df_instances().groupby(self.patterns()).size()
#         upsetplt(data_dict)
